...
export const metadata: Metadata = {
  title: "Términos y Condiciones | America's Boating Club - Boqueron Power Squadron",
        ...
        <div className="card prose prose-lg max-w-none">
          <section className="mb-8">
            ...
            <p className="text-gray-700 leading-relaxed">
              Al acceder y utilizar el sitio web de America&apos;s Boating Club - Boqueron Power
          ...
          <section className="mb-8">
            ...
            <ul className="list-disc list-outside space-y-2 pl-6 text-gray-700">
              ...
              <li>
                El examen oficial requiere inscripción, pago y completar las horas mandatorias del
                curso de navegación.
              </li>
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700 leading-relaxed">
              ...
              es un documento de preparación emitido por America&apos;s Boating Club - Boqueron Power
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700 leading-relaxed">
              ...
              logotipos, gráficos y diseño, es propiedad de America&apos;s Boating Club - Boqueron
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700 leading-relaxed">
              America&apos;s Boating Club - Boqueron Power Squadron se esfuerza por mantener
